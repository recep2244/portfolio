...
1 0 * * 5 NEWSLETTER_SEND_WEEKLY_CURATION_REMINDER=1 NEWSLETTER_START_CURATION_SERVER=1 NEWSLETTER_SYNC_SUBSCRIBERS=1 \"$ROOT_DIR/newsletter/run_daily.sh\" >> \"$LOG_PATH\" 2>&1 $MARKER"
